...
public class SeekerSpawnESC implements EditorSubCommand {
    @Override
    public void onSubCommand(CommandSender sender, String[] args, String editorMapName) {
        ...
        if (gameMap != null) {
            if (sender instanceof Player player) {
                gameMap.setSeekerSpawn(player.getLocation());
                sender.sendMessage("マップ '" + editorMapName + "' の鬼のスポーンを '" + player.getLocation() + "' に設定しました。");
            } else {
